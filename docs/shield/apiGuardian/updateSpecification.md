# `$bunny->shield->apiGuardian->updateSpecification()`

> Shield API · `PATCH /shield/shield-zone/{shieldZoneId}/api-guardian/spec`
...
$result = $bunny->shield->apiGuardian->updateSpecification(shieldZoneId: 123);
```
