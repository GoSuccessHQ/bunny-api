...
namespace GoSuccess\Bunny\Tests\Unit\RateLimit;
...
final class SlidingWindowRateLimiterTest extends TestCase
{
    ...
    public function testBlocksUntilTheOldestRequestLeavesTheWindow(): void
    {
        ...
        // The third request must wait the full window (60s) before a slot frees up.
    ...
    public function testStaysWithinTheLimitOverManyRequests(): void
    {
        ...
        // 25 requests at 10/min: the first 10 are free, the remaining 15 force waits
        // that span at least two further windows.
