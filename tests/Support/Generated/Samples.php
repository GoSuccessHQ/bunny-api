...
final class Samples
{
    ...
    /**
     * A JSON payload populating every property of a model.
     *
    ...
    /**
     * The class of an enum or model type, verified to exist.
     *
     * @return class-string
     */
    public static function classOf(PhpType $type): string
    {
