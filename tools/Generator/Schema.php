...
final class Schema
{
     ...
     * NSwag and Swashbuckle emit around references, and return the schema they
    ...
    /**
     * Whether this is an enum: either a plain `enum` or the Stream style, a
     * `oneOf` of single-value schemas with a `title` each.
     */
