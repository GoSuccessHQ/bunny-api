...
/**
 * Builds query strings the way the bunny.net APIs expect them.
 *
 ...
 * - lists are sent as repeated keys (`type=0&type=1`).
 *
 * @internal
 */
final class Query
{
    ...
    /**
     * Format a single value as it is sent in a query string or a path.
     */
