 ...
 * (60 seconds by default). When the window is full, {@see acquire()} blocks until
 * the oldest request leaves the window, guaranteeing that no more than
 * `$maxRequests` requests are sent per window — and thus avoiding `429` responses
